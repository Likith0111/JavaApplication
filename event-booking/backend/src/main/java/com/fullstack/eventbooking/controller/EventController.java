 ...
 * 
 * <p>This controller exposes endpoints for event management in the event booking
 * platform. It provides CRUD operations for managing events that users can book
 * seats for.</p>
 * 
 * <p><b>Base URL:</b> {@code /api/events}</p>
 * 
 * <p><b>Endpoints:</b></p>
 * <ul>
 *   <li>{@code GET /api/events} - Get all events</li>
 *   <li>{@code GET /api/events/{id}} - Get event by ID</li>
 *   <li>{@code POST /api/events} - Create new event</li>
 *   <li>{@code PUT /api/events/{id}} - Update existing event</li>
 *   <li>{@code DELETE /api/events/{id}} - Delete event</li>
 * </ul>
 * 
 * <p><b>Access Requirements:</b> Public read access for browsing events.
...
public class EventController {
     ...
     * <p><b>Endpoint:</b> {@code /api/events}</p>
     ...
     * 
     * <p><b>HTTP Method:</b> GET</p>
     * <p><b>Endpoint:</b> {@code /api/events/{id}}</p>
     * <p><b>Access:</b> Public</p>
     * 
     * <p><b>Path Parameters:</b></p>
     * <ul>
     *   <li>{@code id} - Event ID</li>
     * </ul>
     * 
     * <p><b>Success Response (200 OK):</b></p>
     * <pre>
     ...
     * 
     * @param id event ID
     * @return ResponseEntity containing EventDto
     */
    @GetMapping("/{id}")
