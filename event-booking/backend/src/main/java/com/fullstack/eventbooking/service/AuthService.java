...
/**
 * Service class handling authentication operations for the event booking platform.
 * 
 ...
 *   <li>Support for multiple user roles (CUSTOMER, EVENT_ORGANIZER, ADMIN)</li>
 * </ul>
 * 
...
public class AuthService {
    ...
    /**
     * Registers a new user in the event booking platform.
     * 
     ...
     * 
     * <p><b>User Roles:</b> Supports registration for customers, event organizers,
     * and administrators, each with appropriate access levels for booking and
     * managing events.</p>
     * 
