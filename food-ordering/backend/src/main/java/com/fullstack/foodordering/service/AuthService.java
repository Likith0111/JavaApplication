...
import com.fullstack.foodordering.dto.AuthResponse;
import com.fullstack.foodordering.dto.LoginRequest;
import com.fullstack.foodordering.dto.RegisterRequest;
...
import com.fullstack.foodordering.security.JwtTokenProvider;
...
/**
 * Service class handling authentication operations for the food ordering platform.
 * 
 ...
 *   <li>Support for multiple user roles (CUSTOMER, RESTAURANT_OWNER, ADMIN)</li>
 * </ul>
 * 
...
public class AuthService {
    ...
    /**
     * Registers a new user in the food ordering platform.
     * 
     ...
     * 
     * <p><b>User Roles:</b> Supports registration for customers, restaurant owners,
     * and administrators, each with appropriate access levels.</p>
     * 
